        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Schedule for <?php echo $clinicName ?></h5>
                            ...
                            <table class="table datatable mydatatable">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM schedules,denreason,dentists,reason,clinicinfo WHERE clinicinfo.clinicID=schedules.clinicID AND denreason.denReasonID=schedules.denReasonID AND denreason.reasonID=reason.reasonID AND denreason.dentistsID=dentists.dentistID AND clinicinfo.clinicID='$clinicID'";
                                    $go_query = mysqli_query($connection, $query);
